...
| **Analytics Engineering** | Data modelling · ELT · pipelines · reporting layers |
| **APIs & Automation** | REST APIs · scheduled jobs · workflow automation |
...
| **Version Control** | Git · GitHub · Acure DevOps |
...
| **Analysis** | Pandas · Jupyter Notebook · data visualisation |
| **Scripting** | Automation scripts · CLI workflows · API integrations |
| **Sandbox Systems** | Vercel · Supabase · Firebase · Firestore · Various LLM APIs |
